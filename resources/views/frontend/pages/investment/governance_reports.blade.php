                ...
                <div class="row">
                    <div class="col-md-12 mb-5">
                        <div class="form-group" style="float: right;">
                            @php
                                $years=App\Models\Government::select('year')->distinct()->orderBy('year' ,'DESC')->get();
                            @endphp
                            <form action="{{route('government.filter')}}" method="get" >
                            ...
                            @if ($governments->count() > 0)
                                @foreach ($governments as $government)
                                    <tr class="text-center">
                                        ...
                                        <td><a href="{{route('government.download',$government->id)}}" id="counter" data-table="government" data-id="{{$government->id}}" data-counter="1"><i class=" fas fa-download"></i></a></td>
                                    </tr>
                                @endforeach
                            @else
                            <tr class="text-center">
