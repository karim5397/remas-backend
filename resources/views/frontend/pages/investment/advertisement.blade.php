                ...
                <div class="row">
                    <div class="col-md-12 mb-5">
                        <div class="form-group" style="float: right;">
                            @php
                                $years=App\Models\Advertisement::select('year')->distinct()->orderBy('year' ,'DESC')->get();
                            @endphp
                            <form action="{{route('advertisement.filter')}}" method="get" >
                            ...
                            @if ($advertisements->count() > 0)
                                @foreach ($advertisements as $advertisement)
                                    <tr class="text-center">
                                        ...
                                        <td><a href="{{route('advertisement.download',$advertisement->id)}}" id="counter" data-table="advertisement" data-id="{{$advertisement->id}}" data-counter="1"><i class=" fas fa-download"></i></a></td>
                                    </tr>
                                @endforeach
                            @else
                            <tr class="text-center">
