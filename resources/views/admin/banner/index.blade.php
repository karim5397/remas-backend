    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">All Banners</h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">All Banners</li>
                </ul>
            </div>
        </div>
        <!--end::Container-->
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-hover  gy-5" >
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @if (count($banners) > 0)
                                @foreach ($banners as $banner )
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="status-btn" type="checkbox" name="toogle" value="{{$banner->id}}" {{$banner->status == 'active' ? 'checked' : ''}} data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="success" data-offstyle="danger"  data-size="sm">
                                        </td>
                                        <td><img src="{{asset($banner->photo)}}"  width="70px" alt=""></td>
                                        <td>
                            ...
                            @else
                                <tr>
                                    <td colspan="5"><p class="text-danger text-center" style="font-size: 25px">No data found!</p></td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
