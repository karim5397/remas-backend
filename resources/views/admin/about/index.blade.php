    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">All About-us</h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">All About-us</li>
                </ul>
            </div>
        </div>
        <!--end::Container-->
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-hover  gy-5" >
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @if (count($abouts) > 0)
                                @foreach ($abouts as $about )
                                    ...
                                    <tr>
                                        ...
                                        <td>{!!$about->value_desc!!}</td>
                                        @php
                                            $photo=explode(',',$about->photo)
                                        @endphp
                                        <td><img src="{{asset($photo[0])}}"  width="70px" alt=""></td>
                            ...
                            @else
                                <tr>
                                    <td colspan="7"><p class="text-danger text-center" style="font-size: 25px">No data found!</p></td>
                                </tr>
                            @endif
