...
<div class="content">
    ...
    <div class="top-bar">
        ...
        <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Show Follow-Up Committee  Reports</li>
            </ol>
        </nav>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Show Follow-Up Committee Reports
        </h2>
     ...
     <div class="grid grid-cols-12 gap-6 mt-5">
         <div class="overflow-x-auto mt-4 col-span-12 sm:col-span-6 xl:col-span-8">
                                 ...
                                 <td>
                                     <div class="flex items-center">
                                         <form action="{{route('follow_up.destroy' , $follow_up->id)}}" method="POST" class="ml-2">
                                             @csrf
                                             @method('DELETE')
                                             <a href="" data-toggle="tooltip" title="{{__('Delete')}}" data-id="{{$follow_up->id}}" data-placement='button' class="dltBtn btn btn-danger"><i class="fa fa-trash"></i></a>
                                         </form>
                                     </div>
                                 </td>
                             </tr>
             ...
             <div class="mt-3 p-3">
                 ...
                 {{$follow_ups->links('pagination::custom')}}
                        ...
                        <div  class="p-5" style="border-radius:10px; border: 1px solid #000">
                            <div class="preview">
                                <h2 class="text-lg font-medium mr-auto pb-4">
                                    Add Follow-Up Committee Reports
                                </h2>
                                <!-- BEGIN: Validation Form -->
                                <form action="{{route('follow_up.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
